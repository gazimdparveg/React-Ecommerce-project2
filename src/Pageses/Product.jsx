...
function Product() {
  return (
    <div>
 <section id="Projects"
    className="w-fit mx-auto grid flex1   sm:w-full sm:grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-14 mt-10 mb-5">
     {
      Data?.map((data)=>{
