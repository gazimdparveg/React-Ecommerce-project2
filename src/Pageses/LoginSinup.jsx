...
function LoginSinup() {
  return (
    <div className=' relative container flex flex-col justify-center p-2 mx-auto sm:py-12   lg:flex-row lg:justify-between'>
     <div className="w-full max-w-md p-8 m-auto mt-11 space-y-3 relative rounded-xl bg-gray-900 text-gray-100">
	<h1 className="text-2xl font-bold text-center">Login</h1>
	<form novalidate="" action="" className="space-y-6">
		<div className="space-y-1 text-sm">
			<label for="username" className="block text-gray-400">Username</label>
			<input type="text" name="username" id="username" placeholder="Username" className="w-full px-4 py-3 rounded-md border-gray-700  text-gray-100 focus:border-violet-400" />
		</div>
		<div className="space-y-1 text-sm">
